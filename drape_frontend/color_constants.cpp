  ...
  { MapStyleClear,
    {
      ...
      { MyPositionAccuracy, dp::Color(247, 208, 72, 20) },
      { Selection, dp::Color(30, 150, 240, 164) },
      { Route, dp::Color(247, 208, 72, 204) },
      { RegionPoly, dp::Color(175, 152, 99, 255) },
      { RoutePedestrian, dp::Color(29, 51, 158, 204) },
      { Arrow3D, dp::Color(247, 208, 72, 255) },
      ...
      { Arrow3DObsolete, dp::Color(247, 208, 72, 255) },
    }
  },
  { MapStyleDark,
    {
